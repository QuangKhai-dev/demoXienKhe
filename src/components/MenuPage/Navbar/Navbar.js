...
export default function Navbar({ setFood, list }) {
  ...
  return (
    <section className="section section-navbar ">
      {/* <Accordion>
        <AccordionItem
          key="district1"
          aria-label="Xiên Khè Quận 1"
          title="Xiên Khè Quận 1"
          className="menuDistrict"
        >
          <Listbox
        ...
        <AccordionItem
          key="otherDistricts"
          aria-label="Các Xiên Khè khác"
          title="Các Xiên Khè khác"
          className="menuDistrict"
        >
          <Listbox
            aria-label="Single selection example"
